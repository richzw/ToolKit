...
- [品味 + 工程思维：AI 时代最难被替代的两件事](https://x.com/dotey/article/2018863908153385290)
  - AI 消灭的是语法层面的痛苦，保留的是工程思维和品味
    - 语法可以交给 AI，但你必须练出工程思维——把需求想清楚、把系统设计清楚、把结果验证清楚的能力
    - AI 抹不平的是 是你脑子里那个“这个项目应该怎么设计”的直觉
    - AI 像是能力倍增器，AI 是乘数，你的基础能力是被乘数
    - 品味可以把它理解成长期决策力——在多个可行方案里，选一个更贴近目标、更省长期维护、更让用户少犯错的方案
    - 工程思维，通俗一点说就是"把事情做稳、把结果做可复现"
      - 拆分：把大问题拆成小问题
      - 全局：不只看当前问题，看整体
      - 三问：边界、故障、验证
